...
DEMO_SITES = [
    ("GK Pokraska — покрасочный цех", "Увеличили заявки на 40% за первый месяц"),
    ("Диана Сокол — регрессолог", "Конверсия 4.8% с холодного трафика"),
    ("Валентина Калугина — стилист", "Запись выросла в 2 раза за месяц"),
    ("Анна Коркина — финансовый директор", "Клиентов с сайта +3 в первый месяц"),
